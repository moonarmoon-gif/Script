...
public class NullifyShield : MonoBehaviour
{
    [Header("Spawn Offset")]
    ...
    [Header("Recharge")]
    public float NullifyRechargeDuration = 60f;
    ...
    public static NullifyShield ActiveShield => activeShield;
    ...
    public bool TryNullifyProjectileHit()
    {
        if (!IsAlive)
        {
            return false;
